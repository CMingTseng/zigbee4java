# Zigbee4java Code refactoring

[![N|Solid](https://www.unipi.technology/assets/content/1140x640/zigbee-logo.png)](https://en.wikipedia.org/wiki/Zigbee)

# FIXED ! (i do not know that project can run ?? but now pass build)

  - This project is fork form https://github.com/AndrejFusek/zigbee4java
